        ...
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('image.update', ['employee' => $employee->id])}}" method="post" enctype="multipart/form-data">
                        @csrf 
                        @method('put')
                        ...
                        <img style="width: 100px; height: 100px;" src="/uploads/employees/{{$employee->image}}" alt="{{$employee->image}}">
                        <div class="mb-3">
